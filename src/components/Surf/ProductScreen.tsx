      ...
      <div className="absolute top-0 left-0 right-0 z-10 transition-all duration-500 ease-in-out"
        ...
        <div className="absolute top-[100px] right-3 z-50" style={{ pointerEvents: 'auto' }}>
          <button 
            ...
            className="bg-black/70 backdrop-blur-md p-2.5 rounded-full border border-white/20 hover:bg-black/90 transition-all active:scale-95 shadow-lg shadow-black/30"
          ...
          <div className={`mb-5 transition-all duration-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col space-y-3">
                ...
                {/* Визуализация количества через иконки - скрываем */}
        ...
        <div className="mt-3 flex justify-between">
          {product.category === 'coffee' || product.category === 'tea' ? (
            <div className="flex items-center justify-between w-full">
              {/* Размер - иконка нужного размера без подписи */}
              <div className="hidden">
                <div 
                  className="transition-all duration-500 ease-out transform"
                  style={{ 
                    height: selectedSize === 'small' ? '24px' : selectedSize === 'medium' ? '32px' : '40px',
                    width: 'auto',
                  }}
                >
                  <svg className="h-full w-auto animate-pulse" viewBox="0 0 24 24" fill="currentColor" style={{color: '#A67C52'}}>
                    <path d="M2,21V19H20V21H2M20,8V5H18V8H20M20,3A2,2 0 0,1 22,5V8A2,2 0 0,1 20,10H18V13A4,4 0 0,1 14,17H8A4,4 0 0,1 4,13V3H20M16,5H6V13A2,2 0 0,0 8,15H14A2,2 0 0,0 16,13V5Z" />
                  </svg>
                </div>
              </div>
                  ...
                  {Array.from({ length: Math.min(quantity, 7) }).map((_, index) => (
                    ...
                    >
                      <svg 
                        ...
                        style={{
                          color: '#A67C52', 
                          height: selectedSize === 'small' ? '24px' : selectedSize === 'medium' ? '30px' : '36px',
                          width: 'auto',
            ...
            <div className="flex justify-between w-full">
              ...
              <div className="flex items-end space-x-1 justify-end w-full">
                {Array.from({ length: Math.min(quantity, 7) }).map((_, index) => (
                  <div 
                    key={index} 
                    className="transition-all"

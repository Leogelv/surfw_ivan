...
const HomeScreen = ({ onCategoryClick, onMenuClick, onCartClick }: HomeScreenProps) => {
  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-b from-[#0A0908] via-[#1E1B19] to-[#0A0908]">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-black/60 backdrop-blur-md px-4 py-3 border-t border-white/10">
        <div className="flex items-center justify-between">
          ...
          {/* Логотип */}
          <div className="relative cursor-pointer" style={{ transform: `scale(${logoScale})`, transition: 'transform 0.8s ease-in-out' }}>
